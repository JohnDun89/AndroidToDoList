...
public class OverrideTouch<SomeCollectionView extends ViewAdapter> extends SwipeToDismissTouchListener<SomeCollectionView> implements
    ...
    public OverrideTouch(SomeCollectionView recyclerView,
    ...
    private void addPendingDismiss(RowContainer dismissView, int dismissPosition) {
        ...
        if(dismissView.undoContainer!=null) {
